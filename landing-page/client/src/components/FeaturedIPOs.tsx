 ...
 *   1. filing.heroImageUrl  — real DALL-E hero from the matching
 *      initiationReport, joined in by filingsClient GROQ. Ideal case.
 *   2. INDUSTRY_IMAGES keyword match — fallback stock photo by industry
 *      label (e.g. "fintech", "biotech").
 *   3. INDUSTRY_IMAGES SIC-range match — handles "SIC NNNN" strings the
 *      poller writes when it can't map a SIC code to a label.
 *   4. Teal gradient placeholder — final fallback.
 */
